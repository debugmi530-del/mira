...
func _finish_game() -> void:
	...
	# Сбрасываем фазу — при следующем запуске игрок увидит MiraChat
	# уже в режиме "пережившего", а не снова HorrorPhase
	MemorySystem.set_value("last_phase", GameState.Phase.COMPANION)
	MemorySystem.set_value("horror_completed", true)
